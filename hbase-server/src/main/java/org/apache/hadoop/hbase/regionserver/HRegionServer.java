...
public class HRegionServer extends HasThread implements
  ...
  private static String ZK_AUTH_KEYFILE_KEY;
  private static String ZK_AUTH_PRINCIPAL_KEY;
  private static String RS_AUTH_KEYFILE_KEY;
  private static String RS_AUTH_PRINCIPAL_KEY;
  ...
  public HRegionServer(Configuration conf, CoordinatedStateManager csm)
    ...
    if(AuthenticationUtil.isTokenAuthEnabled(conf)){
      ZK_AUTH_KEYFILE_KEY="hbase.zookeeper.client.authn.file";
      ZK_AUTH_PRINCIPAL_KEY="hbase.zookeeper.client.tokenauth.principal";
      RS_AUTH_KEYFILE_KEY="hbase.regionserver.authn.file";
      RS_AUTH_PRINCIPAL_KEY="hbase.regionserver.tokenauth.principal";
    }
    else{
      ZK_AUTH_KEYFILE_KEY="hbase.zookeeper.client.keytab.file";
      ZK_AUTH_PRINCIPAL_KEY="hbase.zookeeper.client.kerberos.principal";
      RS_AUTH_KEYFILE_KEY="hbase.regionserver.keytab.file";
      RS_AUTH_PRINCIPAL_KEY="hbase.regionserver.kerberos.principal";
    }
  ...
  protected void login(UserProvider user, String host) throws IOException {
    user.login(RS_AUTH_KEYFILE_KEY,RS_AUTH_PRINCIPAL_KEY, host);
  }
