...
public class TestStoreFile extends HBaseTestCase {
  ...
  public void testReferenceToHFileLink() throws IOException {
    ...
    StoreFile f = new StoreFile(fs, linkFilePath, testConf, cacheConf, BloomType.NONE, NoOpDataBlockEncoder.INSTANCE, null);
  ...
  private void checkHalfHFile(final HRegionFileSystem regionFs, final StoreFile f)
    ...
    StoreFile.Reader top = new StoreFile(this.fs, topPath, conf, cacheConf, BloomType.NONE, NoOpDataBlockEncoder.INSTANCE, null).createReader();
    StoreFile.Reader bottom = new StoreFile(this.fs, bottomPath, conf, cacheConf, BloomType.NONE, NoOpDataBlockEncoder.INSTANCE, null).createReader();
    ...
    try {
      ...
      top = new StoreFile(this.fs, topPath, conf, cacheConf, BloomType.NONE,
          NoOpDataBlockEncoder.INSTANCE, null).createReader();
  ...
  public void testReseek() throws Exception {
    ...
    StoreFile.Reader reader = new StoreFile.Reader(fs, f, cacheConf, DataBlockEncoding.NONE, null);
  ...
  public void testDataBlockEncodingMetaData() throws IOException {
    ...
    StoreFile storeFile = new StoreFile(fs, writer.getPath(), conf,
        cacheConf, BloomType.NONE, dataBlockEncoder, null);
