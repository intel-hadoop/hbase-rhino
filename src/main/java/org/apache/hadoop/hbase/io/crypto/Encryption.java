...
public abstract class Encryption {
  ...
  public static enum Algorithm {
    ...
    public InputStream createDecryptionStream(InputStream downStream,
      ...
      return codec.createInputStream(downStream);
    }
    ...
    public CompressionOutputStream createEncryptionStream(OutputStream downStream,
        Context context) throws IOException {
      CompressionCodec codec = getEncryptionCodec(context);
      return codec.createOutputStream(downStream);
    }
  ...
  /**
   * @return true if the crypto codec for the given algorithm is available
   */
  public static boolean isEncryptionCodecAvailable(Context context) {
    try {
      return getEncryptionCodec(context) != null;
    } catch (Exception e) {
      return false;
    }
  }
