...
public class TestHFileEncryption {
  ...
  public static void setUp() throws Exception {
    ...
    // If this is disabled, version 2.0 blocks are written; we need 2.1+
    conf.setBoolean(HConstants.HBASE_CHECKSUM_VERIFICATION, true);
  }
  ...
  private int writeBlock(FSDataOutputStream os, Compression.Algorithm algo,
    ...
    HFileBlock.Writer hbw = new HFileBlock.Writer(algo, context, null, true,
      HFileReaderV2.MAX_MINOR_VERSION, HFile.DEFAULT_CHECKSUM_TYPE,
  ...
  public void testHFileEncryptionMetadata() throws Exception {
    ...
    if (!Encryption.isEncryptionCodecAvailable(writerContext)) {
