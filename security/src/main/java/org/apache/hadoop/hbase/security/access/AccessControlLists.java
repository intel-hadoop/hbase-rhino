...
public class AccessControlLists {
   ...
   */
  public static byte[] getQualifierFor(KeyValue kv) {
    byte[] bytes = new byte[kv.getFamilyLength() + kv.getQualifierLength()];
    int pos = Bytes.putBytes(bytes, 0, kv.getBuffer(), kv.getFamilyOffset(),
      kv.getFamilyLength());
    pos = Bytes.putBytes(bytes, pos, kv.getBuffer(), kv.getQualifierOffset(),
